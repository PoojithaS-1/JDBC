...
public class MedicalLibraryRetriver {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println();
            String query1 = "select * from medical_library";
            String query2 = "select * from medical_library where book_id=1";
            String query3 = "select * from medical_library where book_id=2 and book_name='Gray Anatomy'";
            String query4 ="select * from medical_library where book_name='Robbins Pathologic Basis of Disease'";
